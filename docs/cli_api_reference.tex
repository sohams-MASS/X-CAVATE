...
\code{-{}-overlap\_algorithm} & str & retrace & Overlap algorithm: \code{retrace} (original) or \code{consecutive} (fast). \\
...
OverlapAlgorithm.CONSECUTIVE   # "consecutive" - Check adjacent pairs
\end{lstlisting}
